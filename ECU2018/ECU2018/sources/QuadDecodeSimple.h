#ifndef _QUADDECODESIMPLE_h
#define _QUADDECODESIMPLE_h
...
*    ENCYA	29	PTB18	 41	Input	    FTM2    6
*    ENCYB	30	PTB19	 42	Input	    FTM2    6
*
* KINETIS REGISTERS
*   PORTx_PCRn
...
public:
	QuadDecode_t() {
		...
		// K20 pin 29,30
		// Bit 8-10 is Alt Assignment							
		PORTB_PCR18 = 0x00000610;	//Alt6-QD_FTM2,FilterEnable,Pulldown
		PORTB_PCR19 = 0x00000610;	//Alt6-QD_FTM2,FilterEnable,Pulldown
