...
uint32_t injectionArray[25] = {
	10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000,10000 //sample values, choosen based on advanced calculations
};
